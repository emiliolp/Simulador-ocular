/**
 *Implementación de los métodos de la clase CalibWindow
 */
...
//Método para almacenar la posición obtenida del tag en la calibración
...
//Método ejecutado tras capturar una imagen en la calibración
void CalibWindow::capture(Fl_Widget *w){
    ...
    if (markerChoosed.empty() == 0 && noExisteTag == false){
        ...
        //Cambiamos la imagen a realzar dependiendo de los capturas realizadas
        if (calibP3d.size() == 1){
